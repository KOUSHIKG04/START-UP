  ...
  return (
    <FadedScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      {checkedIn ? (
        ...
        <>
          <Card borderRadius={radius.md} gap={12} padding={20} style={styles.centeredCard}>
...
function QueueStatus({ onComplete }: { onComplete: () => void }) {
  return (
    <Card borderRadius={radius.lg} gap={20} padding={20} style={styles.centeredCard}>
    ...
    >
      ...
      >
        <SafeAreaView edges={["top"]} style={styles.chatHeaderSafeArea}>
          ...
          <Text numberOfLines={1} style={styles.chatHeaderTitle}>{appointment.doctorName}</Text>
          <Pressable
      ...
      >
        ...
        <ChatBubble received text="I understand. Have you taken the prescribed medicine and checked your temperature?" time="10:14 AM" />
      ...
      <View style={styles.chatInputArea}>
        ...
        <View style={styles.composerRow}>
          ...
          <Pressable
            ...
            onPress={sendMessage}
            style={({ pressed }) => [styles.sendTrigger, !message.trim() ? styles.sendDisabled : undefined, pressed ? styles.pressed : undefined]}
          >
  ...
  return (
    <View style={styles.videoCallScreen}>
      <SafeAreaView edges={["top"]} style={styles.videoSafeArea}>
        <Pressable accessibilityLabel="Go back" accessibilityRole="button" onPress={onBackPress} style={styles.videoBackButton}>
...
function VideoControl({ accessibilityLabel, children, danger = false, onPress }: { accessibilityLabel: string; children: ReactNode; danger?: boolean; onPress: () => void }) {
  return (
    <Pressable accessibilityLabel={accessibilityLabel} accessibilityRole="button" onPress={onPress} style={({ pressed }) => [styles.videoControl, danger ? styles.videoEndControl : undefined, pressed ? styles.pressed : undefined]}>
      {children}
    </Pressable>
  );
}
...
function CompletionView({
  ...
  return (
    ...
    >
      ...
      <Button label="Go to Home" onPress={onGoHome} style={styles.completionMainAction} />
      <Button
